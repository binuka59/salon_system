...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css">
     ...
     <link rel="stylesheet" href="css/wada.css">
...
<body>
     ...
     <section class="products">
            ...
            <h1 class="heading">MALE WEDDING <span> STYLES</span></h1>


     <div class="box-container">
      <?php
         $ret=mysqli_query($con,"select *from  tblservices where type='wedding'&& gender='male' ");
         $cnt=1;
...
<h1 class="heading">FEMALE WEDDING <span> STYLES</span></h1>


<div class="box-container">
<?php
$ret=mysqli_query($con,"select *from  tblservices where type='wedding'&& gender='female' ");
$cnt=1;
$num=mysqli_num_rows($ret);
if($num>0)
{
