...
<head>
    ...
    <title>Ru salon profetional details</title>
...
<section class="abouts" id="about">
    ...
    <h1 class="heading">Profetional details</h1>
    ...
    <div class="row" >
        ...
        <div class="content">
            ...
            <p>Get your hair cut & styled by our expert hair stylists with high quality styling products. Get 50% off when you enter La Source Spa for a styling session. Book your session now. Types: Full Aroma Body Massage, Hot Stones Body Massage, Extra Gentle Body Scrub..</p>
...
<section class="footer">
    ...
    <div class="box-container">
       ...
       <div class="box">
        ...
        <p>o11-1234567</p>
        <a href="#" class="link">rusalon@gmail.com</a>
     </div>
