...
<section class="abouts" id="about">
    ...
    <h1 class="heading">Hair Washing</h1>
    ...
    <div class="row" >
        ...
        <div class="content">
            ...
            <p>Hair washing is the cosmetic act of keeping hair clean by washing it. To remove sebum from hair, some apply a surfactant, usually shampoo (sometimes soap) </p>
